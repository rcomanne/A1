        ...
        protected override void Seed(CinemaTicketSystem.Domain.Concrete.ApplicationDbContext context)
        {
            try {
                ...
                context.Surveys.AddOrUpdate(
                    s => s.Id,
                    new Survey { OverallExperience = 8, MovieExperience = 9, TravelExperience = 7, BathroomExperience = 7, FoodExperience = 8, StaffExperience = 8, ShopExperience = 8, Comment = "Toiletten waren niet erg fris, wel aardig personeel" },
                    new Survey { OverallExperience = 6, MovieExperience = 7, TravelExperience = 6, BathroomExperience = 6, FoodExperience = 7, StaffExperience = 6, ShopExperience = 6, Comment = "WC's vies, parkeergelegenheid blijft slecht" },
                    new Survey { OverallExperience = 7, MovieExperience = 6, TravelExperience = 7, BathroomExperience = 5, FoodExperience = 6, StaffExperience = 7, ShopExperience = 7, Comment = "Top bios! Alleen beetje jammer van de puinhoop bij de dames toiletten" },
                    new Survey { OverallExperience = 4, MovieExperience = 5, TravelExperience = 4, BathroomExperience = 3, FoodExperience = 5, StaffExperience = 4, ShopExperience = 4, Comment = "Alles is vies, personeel zit er maar een beetje en wilde mij totaal niet helpen..." },
                    new Survey { OverallExperience = 6, MovieExperience = 6, TravelExperience = 5, BathroomExperience = 6, FoodExperience = 6, StaffExperience = 6, ShopExperience = 6, Comment = null },
                    new Survey { OverallExperience = 8, MovieExperience = 7, TravelExperience = 8, BathroomExperience = 6, FoodExperience = 7, StaffExperience = 7, ShopExperience = 7, Comment = null },
                    new Survey { OverallExperience = 7, MovieExperience = 8, TravelExperience = 8, BathroomExperience = 5, FoodExperience = 6, StaffExperience = 6, ShopExperience = 6, Comment = null },
                    new Survey { OverallExperience = 5, MovieExperience = 7, TravelExperience = 4, BathroomExperience = 5, FoodExperience = 5, StaffExperience = 8, ShopExperience = 8, Comment = "Prachtige bios! Ziet er net zo gelikt uit als de website!" },
                    new Survey { OverallExperience = 6, MovieExperience = 7, TravelExperience = 5, BathroomExperience = 5, FoodExperience = 7, StaffExperience = 5, ShopExperience = 5, Comment = "Een beetje zoals verwacht, niet echt goed maar zo slecht is het nou ook weer niet... Gewoon even flink de boel poetsen!" },
                    new Survey { OverallExperience = 6, MovieExperience = 8, TravelExperience = 6, BathroomExperience = 5, FoodExperience = 7, StaffExperience = 6, ShopExperience = 6, Comment = "Prima bioscoopje!" }
                );
                ...
                foreach (var errors in ex.EntityValidationErrors) {
                    foreach (var error in errors.ValidationErrors) {
                        System.Console.WriteLine("Property: {0} Error: {1}", error.PropertyName, error.ErrorMessage);
                    }
                }
            }
        }
